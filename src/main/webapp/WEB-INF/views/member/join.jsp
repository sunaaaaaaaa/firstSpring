     ...
     <table border="1">
        <tr>
           ...
           <td >
           	  ...
           	  <c:if test="${empty error.userId}">
           	  		<span id="idCheck" class="valid-msg"></span> <!-- validator통과햇더라도 span태그 자체는 있어야하기때문 -->
           	  </c:if>
           	  <form:errors path="userId" id="idCheck" cssClass="valid-msg"/><!-- validator 통과못하면 span태그 만들어줌 -->
           </td> <!-- userId에 값이 있으면 -->
        </tr>
        <tr>
           <td>PASSWORD : </td>
           <td>
           	  ...
           	  required/>
           	  <form:errors path="password" id="password" cssClass="valid-msg"/> 
           </td>
        </tr>
        <tr>
           <td>휴대폰번호 : </td>
